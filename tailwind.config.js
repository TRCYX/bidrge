...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        emoji: ["Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "ui-sans-serif", "system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "Noto Sans", "sans-serif"],
      },
      width: {
        "128": "32rem",
        "160": "40rem",
